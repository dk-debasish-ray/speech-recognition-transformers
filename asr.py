...
import os
# Replace with your actual FFmpeg bin directory path
os.add_dll_directory(r"D:\ffmpeg-8.0.1-full_build-shared\ffmpeg-8.0.1-full_build-shared\bin")
...
# %%
get_transcription_wav2vec2("audio.wav", 
                           wav2vec2_model, 
                           wav2vec2_processor)
